    ...
    axios
      ...
      .then(res => {
        ...
        this.setState({
          ...
          ratio: (vote_average / 2).toFixed(1),
          runtime,
          release_date,
        ...
        <div className="movie__box">
          ...
          <div className="movie__ranking">
            <div className="starbox">
              <img src={star_fill} alt="star icon" className="starbox__img" />
              <img src={star_fill} alt="star icon" className="starbox__img" />
              <img src={star_fill} alt="star icon" className="starbox__img" />
              <img src={star_half_fill} alt="star icon" className="starbox__img" />
              <img src={star_no_fill} alt="star icon" className="starbox__img" />
              <span className="starbox__ratio">{ratio} / 5</span>
            </div>
            <div className="info">
